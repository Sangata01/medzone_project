                ...
                <%
                    ...
                    if (customerSession != null && customerSession.getAttribute("customerId") != null) {
                        ...
                        try {
                            ...
                            PreparedStatement ps = con.prepareStatement(" select  oid,  Pid, quantity,price,state, city, address, pincode,TotalPrice from orders where pid in (select id from products where sid = ?)");
