    ...
    <div class="signup-form">
        ...
        <form action="reg.jsp" method="post">
            ...
            <div class="location-row">
                <input name="st" type="text" placeholder="State" required>
                <input name="ct" type="text" placeholder="City" required>
            </div>
            <div class="address-row">
                <textarea name="sno" placeholder="Address" required></textarea>
                <input name="pin" type="text" placeholder="Pincode" required>
            </div>
            <input name="email" type="email" placeholder="Email" required>
            <div class="phone-row">
                <input name="phno" type="tel" placeholder="Phone Number" required>
            </div>
            <div class="password-row">
                <input name="pass" type="password" placeholder="Password" required>
                <input name="cp" type="password" placeholder="Confirm Password" required>
            </div>
            <button name="submit" type="submit">Register</button>
            <p class="login-link">Already have an account? <a href="log_cou.jsp" style="color: red;">Sign in here</a></p>
        </form>
    </div>
