        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <%
                    ...
                    if (customerSession != null && customerSession.getAttribute("customerId") != null) {
                        ...
                        try {
                            ...
                            PreparedStatement ps = con.prepareStatement("Select id,FName ,LName ,City ,State ,Address,Pincode  ,Email ,PhoneNumber  ,Password ,ConfirmPassword from coustomer  WHERE id = ?");
                ...
                %>
								...
								<h4 class="card-title">Name: <%= rs.getString("FName") + " " + rs.getString("LName") %></h4>
							    <h4 class="card-title">City :<%= rs.getString("City") %></h4>
							    <h4 class="card-title">State: <%= rs.getString("State") %></h4>
							    ...
							    <h4 class="card-text">Password: <%= rs.getString("Password") %></h4>                                        
							</div>
